...
(function() {
  var MongoClient, ObjectID, WORKER_JS, allowCrossDomain, app, assert, bodyParser, compression, db, db_url, express, fs, getWork, get_slices, morgan, serveStatic, shuffle, trusted_hosts, _;
