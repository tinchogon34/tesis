...
(function() {
  var DATA_URL, LOG_URL, POST_URL, Task, WORK_URL, blob, data, get_work_interval, get_work_running, intervalId, log_to_server, pause, process_response, sleep_time, slice_id, start_worker, t, task_id, tiempo_de_ejecucion, toggle_pause, wait_for_new_tasks, worker, worker_code, _Worker;
